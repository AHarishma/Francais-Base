...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find the View that shows the days category

        TextView days = (TextView) findViewById(R.id.days);

        // Set a click listener on that View
        days.setOnClickListener(new OnClickListener() {
            // The code in this method will be executed when the days category is clicked on.
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link DaysActivity}
