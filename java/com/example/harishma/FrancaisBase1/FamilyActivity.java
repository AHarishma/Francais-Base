...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("older sister", "soeur cadette", R.drawable.family_older_sister));
        words.add(new Word("younger sister", "soeur ainee", R.drawable.family_younger_sister));
